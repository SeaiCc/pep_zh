...
> .read(n: int = -1) -> str.write(s: str) -> int
...
be wrapped with the TextIOWrapper.encoding refers to an encoding to be used for translating
...
- Copyright
 ...
 [Page Source (GitHub)](https://github.com/python/peps/blob/main/peps/pep-3116.rst?plain=1)
