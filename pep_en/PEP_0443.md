...
- does not have a simple or straightforward way for developers to
create new generic functions,

- does not have a standard way for methods to be added to existing
...
for the standard library [2], and the best practices for
...
adaptation and method combining. PEAK-Rules [4] is
...
In a 2005 article on Artima [5] Guido van Rossum presents
...
generic package available on PyPI [6], as well as David
Mertz’s gnosis.magic.multimethods [7].
...
PyPy’s RPython offers extendabletype [8], a metaclass which
...
[9] that proposed exposing pkgutil.simplegeneric as part
of the functools API, Guido van Rossum’s article on multimethods
[5], and discussions with Raymond Hettinger on a general
...
[[2](#id2)]
[PEP 8](../pep-0008/) states in the “Programming Recommendations”
...
- Copyright
 ...
 [Page Source (GitHub)](https://github.com/python/peps/blob/main/peps/pep-0443.rst?plain=1)
