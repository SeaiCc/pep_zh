...
objects came up several times. It also limits pickling support [1].
...
XML specification [2]) found it obscure and non-obvious, which is why the
...
[[2](#id2)]
“QName” entry in Wikipedia:
[http://en.wikipedia.org/wiki/QName](http://en.wikipedia.org/wiki/QName)
...
- Copyright
 ...
 [Page Source (GitHub)](https://github.com/python/peps/blob/main/peps/pep-3155.rst?plain=1)
