...
and making 1/2 return a rational rather than a float. See [PEP 239](../pep-0239/).
...
> Use x*1.0/y for true division, divmod(x, y) ([PEP 228](../pep-0228/)) for int
...
> They inherit the choice from the invoking module. [PEP 236](../pep-0236/) now lists
this as a resolved problem, referring to [PEP 264](../pep-0264/).

### What about code compiled by the codeop module?

> This is dealt with properly; see [PEP 264](../pep-0264/).
...
- Copyright
 ...
 [Page Source (GitHub)](https://github.com/python/peps/blob/main/peps/pep-0238.rst?plain=1)
