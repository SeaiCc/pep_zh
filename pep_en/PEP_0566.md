...
metadata fields is the Core Metadata Specification document.
...
- Acknowledgements
 ...
 [Page Source (GitHub)](https://github.com/python/peps/blob/main/peps/pep-0566.rst?plain=1)
