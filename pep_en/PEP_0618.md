...
standard library that much (if not most) zip usage
...
In fact, the author has counted dozens of other call sites in Python’s standard library and tooling where it
...
- Copyright
 ...
 [Page Source (GitHub)](https://github.com/python/peps/blob/main/peps/pep-0618.rst?plain=1)
