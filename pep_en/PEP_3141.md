...
inspired by a Haskell Numeric Prelude [1] including
...
- Possible Python 3K Class Tree?, wiki page by Bill Janssen(https://wiki.python.org/moin/AbstractBaseClasses)

[[1](#id2)]
NumericPrelude: An experimental alternative hierarchy
of numeric type classes
([https://archives.haskell.org/code.haskell.org/numeric-prelude/docs/html/index.html](https://archives.haskell.org/code.haskell.org/numeric-prelude/docs/html/index.html))

[[2](#id1)]
The Scheme numerical tower
([https://groups.csail.mit.edu/mac/ftpdir/scheme-reports/r5rs-html/r5rs_8.html#SEC50](https://groups.csail.mit.edu/mac/ftpdir/scheme-reports/r5rs-html/r5rs_8.html#SEC50))
...
- Copyright
 ...
 [Page Source (GitHub)](https://github.com/python/peps/blob/main/peps/pep-3141.rst?plain=1)
