...
- **BDFL-Delegate**: Mark Mangoba &lt;mmangoba&#32;&#97;t&#32;python.org&gt;
- **Created**: 12-Jan-2017
...
- User A and User B share project X. After some time they part ways
and each of them wants to continue the project under name X.

- User A owns a project X outside the Package Index. User B creates
...
- User A publishes project X to the Package Index. After some time
...
issue by respectful communication (see the PSF Code of Conduct [6]).
...
The Python Software Foundation [7] is the non-profit legal entity that
...
Recommendations made by the Board are sent to the Packaging Workgroup [8] for review.
...
- Try to contact the current owner(s) directly: email them and open an issue
...
- Check the criteria above to see when a transfer is allowed. In particular,
the criteria for reusing a name for a different project
are more stringent than for continuing maintenance of the same project - although it’s not easy to get a name transferred
in either case.

- Search the PyPI Support issues
...
[[1](#id1)]
Terms of Use of the Python Package Index
...
- Acknowledgements
 ...
 [Page Source (GitHub)](https://github.com/python/peps/blob/main/peps/pep-0541.rst?plain=1)
